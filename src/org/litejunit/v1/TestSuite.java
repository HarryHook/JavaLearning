    ...
    private void addTestMethod(Method m, Vector<String> names, Constructor<?> constructor) {
        ...
        if (isPublicTestMethod(m)) {
            ...
            try {
                ...
                addTest(warning("Cannot instantiate forjob case: " + name + " (" + exceptionToString(e) + ")"));
            } catch (InvocationTargetException e) {
                addTest(warning("Exception in constructor: " + name + " (" + exceptionToString(e.getTargetException()) + ")"));
            } catch (IllegalAccessException e) {
                addTest(warning("Cannot access forjob case: " + name + " (" + exceptionToString(e) + ")"));
            }

        } else { // almost a forjob method
            if (isTestMethod(m))
